# Desafío Clase 42 - Coderhouse - Backend - Camada 30930
...
Por ejemplo, el día 01 de Agosto del 2022 corrí los tests, se generó **`TestResults_2022-08-01.txt`** en la carpeta `testresults`

```console
cat testresults/TestResults_2022-08-01.txt
